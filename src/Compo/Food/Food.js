...
function Food() {
  return (
    ...
    <section className='d-flex mb-5' style={{marginTop: '120px'}}>
            ...
            <div className='p-4 pb-2 border'
                style={{marginLeft:'7em',width:'32em',height:'32em',lineHeight: '1.8' ,borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 fw-bold'>Food of Rameshwaram</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
        ...
        <section className='d-flex mb-5' style={{marginTop: '50px'}}>
            <div className='p-4 pb-2 border'
                style={{marginLeft:'3em',width:'32em',height:'32em',lineHeight: '1.8' ,borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 fw-bold'>Food of Kodaikanal</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
            ...
            <div className='p-4 pb-2 border'
                style={{marginLeft:'7em',width:'32em',height:'32em',lineHeight: '1.8' ,borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 fw-bold'>Food of Ooty</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
        ...
        <section className='d-flex mb-5' style={{marginTop: '50px'}}>
            <div className='p-4 pb-2 border'
                style={{marginLeft:'3em',width:'32em',height:'32em',lineHeight: '1.8' ,borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 fw-bold'>Food of Kanyakumari</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
            ...
            <div className='p-4 pb-2 border'
                style={{marginLeft:'7em',width:'32em',height:'32em',lineHeight: '1.8' ,borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 fw-bold'>Food of Kumbakonam</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
        ...
        <section className='d-flex mb-5' style={{marginTop: '50px'}}>
            <div className='p-4 pb-2 border'
                style={{marginLeft:'3em',width:'32em',height:'32em',lineHeight: '1.8' ,borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 fw-bold'>Food of Madurai</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
            ...
            <div className='p-4 pb-2 border'
                style={{marginLeft:'7em',width:'32em',height:'32em',lineHeight: '1.8' ,borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 fw-bold'>Food of Yercaud</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
        ...
        <section className='d-flex mb-5' style={{marginTop: '50px'}}>
            <div className='p-4 pb-2 border'
                style={{marginLeft:'3em',width:'32em',height:'32em',lineHeight: '1.8' ,borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 fw-bold'>Food of Hogenakkal</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
            ...
            <div className='p-4 pb-2 border'
                style={{marginLeft:'7em',width:'32em',height:'32em',lineHeight: '1.8' ,borderRadius:'6%',
                boxShadow:'2px 2px 5px 3px gray'}}>
                <h5 className='text-center mt-2 mb-4 fw-bold'>Food of Theni</h5>
                <p style={{textAlign:'justify',textIndent:'15%',boxShadow:'40px'}}>
